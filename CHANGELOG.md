...
## [2.5.0](https://github.com/secondtruth/puter/compare/v2.4.0...v2.5.0) (2024-07-20)


### Features

* add (pt-br) translation for system settings. ([77211c4](https://github.com/secondtruth/puter/commit/77211c4f71b0285fb3060f7e5c8d493b4d7c4f0c))
* add /group/list endpoint ([d55f38c](https://github.com/secondtruth/puter/commit/d55f38ca68899c3574cfe328d2b206b1143ff0d4))
* add /share/file-by-username endpoint ([5d214c7](https://github.com/secondtruth/puter/commit/5d214c7b52887b594af6be497f1892baf7d77679))
* add /sharelink/request endpoint ([742f625](https://github.com/secondtruth/puter/commit/742f625309f9f4cfa70cf7d2fe5b03fd164913ea))
* add /show urls ([079e25a](https://github.com/secondtruth/puter/commit/079e25a9fe8e179f26d72378856058eb656e2314))
* add app metadata ([f7216b9](https://github.com/secondtruth/puter/commit/f7216b95672b38802b288ef5b022e947017ff311))
* add appdata permission (if applicable) on app share ([9751fd9](https://github.com/secondtruth/puter/commit/9751fd92a50e75385cffed0ca847d5076ba98c92))
* add cookie for site token ([a813fbb](https://github.com/secondtruth/puter/commit/a813fbbb88bcfb8b9a61976e2a4fc4aab943fc88))
* add cross_origin_isolation option ([e539932](https://github.com/secondtruth/puter/commit/e53993207077aecd2c01712519251993bb2562bc))
* add cross-server event broadcasting ([1207a15](https://github.com/secondtruth/puter/commit/1207a158bdc88a90b14d31d03387ce353c176a9c))
* add debug mod ([16b1649](https://github.com/secondtruth/puter/commit/16b1649ff62fd87a4dda5d2e1c68941c864c5da4))
* add endpoints for share tokens ([301ffaf](https://github.com/secondtruth/puter/commit/301ffaf61dbb4fca1a855650ab80707ae6d9f602))
* add external mod loading ([eb05fbd](https://github.com/secondtruth/puter/commit/eb05fbd2dc4877553b5118a069a9afdc32bea137))
* add group management endpoints ([4216346](https://github.com/secondtruth/puter/commit/4216346384d90dcba429dbcb175e6f86482d19f4))
* add group permission endpoints ([c374b0c](https://github.com/secondtruth/puter/commit/c374b0cbca761e7c8a47d56a09551f2e9378066a))
* add mark-read endpoint ([0101f42](https://github.com/secondtruth/puter/commit/0101f425d480705c20df4919a76f66e987f5790f))
* add option to disable temporary users ([f9333b3](https://github.com/secondtruth/puter/commit/f9333b3d1e05bd0dffaecd2e29afd08ea61559fc))
* add permission rewriter for app by name ([16c4907](https://github.com/secondtruth/puter/commit/16c4907be592dae31ed3c1aa3fac3b9655255d6f))
* add protected apps ([f2f3d6f](https://github.com/secondtruth/puter/commit/f2f3d6ff460932698fb8da7309fbce3e96132950))
* add protected subdomains ([86fca17](https://github.com/secondtruth/puter/commit/86fca17fb17c0c24397c29b49b133deadea1de8b))
* add querystring-informed errors ([e7c0b83](https://github.com/secondtruth/puter/commit/e7c0b8320a6829315d9154d6d513bab4491c47ea))
* add readdir delegate for shares in a user directory ([8424d44](https://github.com/secondtruth/puter/commit/8424d446099ac30ccf829c57d43eef1f235618e4))
* add readdir delegate for sharing user homedirs ([19a5eb0](https://github.com/secondtruth/puter/commit/19a5eb00763f3ac31df8483fb59cb7a96c448745))
* add service for notifications ([a1e6887](https://github.com/secondtruth/puter/commit/a1e6887bf93da21b9482040b3e30ee083fb23477))
* add service to test file share logic ([332371f](https://github.com/secondtruth/puter/commit/332371fccb198462948a440419adc7a26d671a23))
* add share list to stat ([8c49ba2](https://github.com/secondtruth/puter/commit/8c49ba2553ce6bee20eb5b6f2721bc80f639e98a))
* add share service and share-by-email to /share ([db5990a](https://github.com/secondtruth/puter/commit/db5990a98935817c0e16d30e921bb99c57a98fc8))
* add some default groups ([ba50d0f](https://github.com/secondtruth/puter/commit/ba50d0f96d58075abec067d24e6532bd874093f0))
* add subdomain permission (if applicable) on app share ([13e2f72](https://github.com/secondtruth/puter/commit/13e2f72c9f33f485570f13f45341246b1a05879f))
* add user-group permission check ([0014940](https://github.com/secondtruth/puter/commit/00149402e041443aa3ac571fbe97a9a85f95564b))
* **backend:** add script service ([30550fc](https://github.com/secondtruth/puter/commit/30550fcddda18469735499546de502d29b85e2ad))
* **backend:** Add tab completion to server console command arguments ([fa81dca](https://github.com/secondtruth/puter/commit/fa81dca9507b7fa0f82099b75f2ab89c865626ac))
* **backend:** Add tab-completion to server console command names ([e1e76c6](https://github.com/secondtruth/puter/commit/e1e76c6be71fdeb3b6246307b626734d8dc26f86))
* **backend:** add tip of day ([2d8e624](https://github.com/secondtruth/puter/commit/2d8e6240c61dc6301f49cbdcd1c3b04736f9ca93))
* **backend:** allow services to provide user properties ([522664d](https://github.com/secondtruth/puter/commit/522664d415c33342500defec309c2ff15bc94804))
* **backend:** improve logger and reduce logs ([4bdad75](https://github.com/secondtruth/puter/commit/4bdad75766d0617a164024b39b79bf5373c495a6))
* Display app icon and description in embeds ([ef298ce](https://github.com/secondtruth/puter/commit/ef298ce3aa3ce90224e883fb0ba33f9cd3a3da44))
* get first test working on share-test service ([88d6bee](https://github.com/secondtruth/puter/commit/88d6bee9546f36d689c53ec7fe95f01f772f5211))
* **git:** Add --color and --no-color options ([d6dd1a5](https://github.com/secondtruth/puter/commit/d6dd1a5bb0a2b2bba2cfe86d2e51ff2a6e42841c))
* **git:** Add a --debug option, which sets the DEBUG global ([fa3df72](https://github.com/secondtruth/puter/commit/fa3df72f6ed2d45a440ebc2aacbbae67bf042478))
* **git:** Add authentication to clone, fetch, and pull. ([364d580](https://github.com/secondtruth/puter/commit/364d580ff896691ee70d3735f495c720651a9f41))
* **git:** Add diff display to `show` and `log` subcommands ([3cad1ec](https://github.com/secondtruth/puter/commit/3cad1ec436f99a78f782ab9576325d4341284964))
* **git:** Add start-revision and file arguments to `git log` ([49c2f16](https://github.com/secondtruth/puter/commit/49c2f163515d2130c17a6f6a6a16bc27ea69336a))
* **git:** Allow checking out a commit instead of a branch ([057b3ac](https://github.com/secondtruth/puter/commit/057b3acf00af49c005b9bf7069c5d22983a32e1e))
* **git:** Color output for `git status` files ([bab5204](https://github.com/secondtruth/puter/commit/bab5204209aa2efc0c053643677a78db6ede0929))
* **git:** Display file contents as a string for `git show FILE_OID` ([a680371](https://github.com/secondtruth/puter/commit/a68037111a04580cfa2688694a68ef6ac7a495fa))
* **git:** Display ref names in `git log` and `git show` ([45cdfcb](https://github.com/secondtruth/puter/commit/45cdfcb5bfa66937b33054a127e0b17001f3faa4))
* **git:** Format output closer to canonical git ([60976b1](https://github.com/secondtruth/puter/commit/60976b1ed61984d9d290f3a0ae99dd97632e9909))
* **git:** Handle detached HEAD in `git status` and `git branch --list` ([2c9b1a3](https://github.com/secondtruth/puter/commit/2c9b1a3ffc3d5e282ffe5b83a86314e99445bbc6))
* **git:** Implement `git branch` ([ad4f132](https://github.com/secondtruth/puter/commit/ad4f13255d52f8226f22800c16b388cf0e6384d7))
* **git:** Implement `git checkout` ([35e4453](https://github.com/secondtruth/puter/commit/35e4453930bc4e151887f83c97efec19cc15da70))
* **git:** Implement `git cherry-pick` ([2e4259d](https://github.com/secondtruth/puter/commit/2e4259d267b3cfafd5cefc57a02643c6432fec4d))
* **git:** Implement `git clone` ([95c8235](https://github.com/secondtruth/puter/commit/95c8235a4a1fea39a46c40df04cb1004a2fe7b23))
* **git:** Implement `git diff` ([622b6a9](https://github.com/secondtruth/puter/commit/622b6a9b921c3c03efc0b519c9a26c6701d80e50))
* **git:** Implement `git fetch` ([98a4b9e](https://github.com/secondtruth/puter/commit/98a4b9ede39b94c0c6b6b8345d7551359961186a))
* **git:** Implement `git pull` ([eb2b6a0](https://github.com/secondtruth/puter/commit/eb2b6a08b03cee0612885412cd4b03c9564044e3))
* **git:** Implement `git push` ([8c70229](https://github.com/secondtruth/puter/commit/8c70229a188b743220db076a740a992fd7971301))
* **git:** Implement `git remote` ([43ce0d5](https://github.com/secondtruth/puter/commit/43ce0d5b45d4eb4f296afcaaa1ecadc125c53e89))
* **git:** Implement `git restore` ([4ba8a32](https://github.com/secondtruth/puter/commit/4ba8a32b45d395f28433572db5644d630776789e))
* **git:** Make `git add` work for deleted files ([9551544](https://github.com/secondtruth/puter/commit/955154468f48e45028dad2e916708d6a763affad))
* **git:** Make shorten_hash() guaranteed to produce a unique hash ([dd10a37](https://github.com/secondtruth/puter/commit/dd10a377493c0d8f10a1ac8779dc27f3f3bf6c37))
* **git:** Resolve more forms of commit reference ([b6906bb](https://github.com/secondtruth/puter/commit/b6906bbcaaa50fc8a8c60beb6d2d38bcb7dda758))
* **git:** Understand references like `HEAD^` and `main~3` ([711dbc0](https://github.com/secondtruth/puter/commit/711dbc0d2fde9c2ddc6c86f64fb4caa7837c9dcb))
* implicit access from apps to shared appdata dirs ([31d4eb0](https://github.com/secondtruth/puter/commit/31d4eb090efb340fdfb7cb6b751145e859624eeb))
* introduce notification selection via driver ([c5334b0](https://github.com/secondtruth/puter/commit/c5334b0e19cf9762f536ec482c3ff872e9c12399))
* JSON support for kv driver ([3ed7916](https://github.com/secondtruth/puter/commit/3ed7916856f03eafbe0891f2ab39c34d20d2bd24))
* multi-recipient multi-file share endpoint ([846fdc2](https://github.com/secondtruth/puter/commit/846fdc20d4a887a1f8a4f3bda4fafe41efab2733))
* **phoenix:** Make `clear` clear scrollback unless `-x` is given ([75a989a](https://github.com/secondtruth/puter/commit/75a989a7b69bfdfdf69e5f0365027c5b27d8bfc6))
* **phoenix:** Show actual host name in prompt and neofetch ([4539408](https://github.com/secondtruth/puter/commit/4539408a218a50244dc615cf7de56c29dcac53e6))
* rate-limit for excessive groups ([4af279a](https://github.com/secondtruth/puter/commit/4af279a72fc9de89ddc3ba51806ca3760a36265d))
* re-send unreads on login ([02fc4d8](https://github.com/secondtruth/puter/commit/02fc4d86b7166fb4803be5d28e2a593d6b7d9785))
* register dev center to apps ([10f4d7d](https://github.com/secondtruth/puter/commit/10f4d7d50ce9314f9c3888c74cb17c8ebbecee98))
* send notification when file gets shared ([2f6c428](https://github.com/secondtruth/puter/commit/2f6c428a403a006f7878861d2f0356c3294519be))
* start directory index frame ([fb1e2f2](https://github.com/secondtruth/puter/commit/fb1e2f21fb67aefe0602f6c978199c7cd019bbf7))
* support canonical puter.js url in dev ([fd41ae2](https://github.com/secondtruth/puter/commit/fd41ae217c7a9f7229326f62a829471580a744bd))
* update BR translation ([42a6b39](https://github.com/secondtruth/puter/commit/42a6b3938a588b8b4d1bd976c37e9c6e58408c75))
* update share endpoint to support more things ([dd5fde5](https://github.com/secondtruth/puter/commit/dd5fde5130c1840ab598e6622766ae835142e58a))


### Bug Fixes

* `launch_app` not considering `explorer` as a special case ([98e6964](https://github.com/secondtruth/puter/commit/98e69642d027a83975a0b2b825317213098bb689))
* add app_uid param to kv interface ([f7a0549](https://github.com/secondtruth/puter/commit/f7a054956b8739a3bc305a49faee929ea0da1e15))
* add missing columns for public directory update ([b10302a](https://github.com/secondtruth/puter/commit/b10302ad744fd9c58f9735743e075815183c772c))
* add permission implicator for file modes ([e63ab3a](https://github.com/secondtruth/puter/commit/e63ab3a67f6555eb13d6af477a8da9f1b54d6608))
* add stream limit ([ceba309](https://github.com/secondtruth/puter/commit/ceba309dbd4df89f310d1a530f939a5b7991f4c7))
* **backend:** remove a bad thing that really doesn't work ([8d22276](https://github.com/secondtruth/puter/commit/8d22276f13106f7642d11da30b1500817a20ad43))
* bug introduced when refactoring /share to Sequence ([ecb9978](https://github.com/secondtruth/puter/commit/ecb997885c1efb766827c84d2ffb8dc6ddabe992))
* column nullability blunder ([1429d6f](https://github.com/secondtruth/puter/commit/1429d6f57c67dff51fc41ca0c2868f8d000845f1))
* correct shown flag behavior ([632c536](https://github.com/secondtruth/puter/commit/632c5366161ff8fbbd4d60c61dfbe52dad488a2c))
* database migration ([9b39309](https://github.com/secondtruth/puter/commit/9b39309e18a2927d25fe794d91da4e4d068c4bca))
* do not delegate to select on read like ever that is really dumb ([a2a10b9](https://github.com/secondtruth/puter/commit/a2a10b94be59403e03fb08bec5d7c056ce5b554f))
* docker runtime fail because stdout columns ([94c0449](https://github.com/secondtruth/puter/commit/94c0449437ce4cb26d00a15a3f277bc7b09367b4))
* fix CI attempt [#2](https://github.com/secondtruth/puter/issues/2) ([aebe89a](https://github.com/secondtruth/puter/commit/aebe89a1acb070764551e8e89e325325ffbed8f9))
* fix CI attempt [#3](https://github.com/secondtruth/puter/issues/3) ([3bca973](https://github.com/secondtruth/puter/commit/3bca973f5f4e65a2bd24c634c347fbd681a7458b))
* fix CI attempt [#4](https://github.com/secondtruth/puter/issues/4) ([84b993b](https://github.com/secondtruth/puter/commit/84b993bce913c3ad99127063bcfaae19331b199c))
* fix CI attempt [#5](https://github.com/secondtruth/puter/issues/5) ([74adcdd](https://github.com/secondtruth/puter/commit/74adcddc1d60e0a513408a0716ed2b301126225d))
* fix CI attempt [#6](https://github.com/secondtruth/puter/issues/6) ([9d549b1](https://github.com/secondtruth/puter/commit/9d549b192d149eac96c316ded645bf7c2e96153d))
* fix CI attempt [#7](https://github.com/secondtruth/puter/issues/7) ([614f2c5](https://github.com/secondtruth/puter/commit/614f2c5061525f230ccd879bfb047434ac46a9ba))
* fix issues with apps in /share endpoint ([0cf90ee](https://github.com/secondtruth/puter/commit/0cf90ee39af6548d271dec45ed8ee9e6df1cd14d))
* fix owner ids for default apps ([283f409](https://github.com/secondtruth/puter/commit/283f409a662d126e7f3ce811f1467ac6fab9a522))
* fix path issues under win32 platform ([d80f2fa](https://github.com/secondtruth/puter/commit/d80f2fa847bfaef98dc8d482898f5c15f268e4bd))
* fix permission cascade properly this time ([de58866](https://github.com/secondtruth/puter/commit/de5886698e1eae2b250baac174b57029f3244e96))
* fix that fix ([b126b67](https://github.com/secondtruth/puter/commit/b126b670940a0e20cfe7bd0eba3db891bab5c142))
* fix typo ([ce328b7](https://github.com/secondtruth/puter/commit/ce328b7245ad741b64c5885f64f806fc98a55d84))
* **git:** Make git commit display detached HEAD correctly ([73d0f5a](https://github.com/secondtruth/puter/commit/73d0f5a90cb5dcbadfc6d0fd22f14e8bc0e61f86))
* group permission audit table ([7d2f6d2](https://github.com/secondtruth/puter/commit/7d2f6d256f56e30d752e9999c6e8bde68f9d9637))
* handle subpaths under another user ([d128cee](https://github.com/secondtruth/puter/commit/d128ceed6f4928fa0793815feb2e2715cd273ff8))
* handling of batch requests with zero files ([c0063a8](https://github.com/secondtruth/puter/commit/c0063a871fd891a1774f1bee00e86170fed249fa))
* i forgot to test reloading ([7eabb43](https://github.com/secondtruth/puter/commit/7eabb43bd4257b4129d67eaeda2aa27e8268dc78))
* **i18n:** update zhtw.js to match en.js ([37fd666](https://github.com/secondtruth/puter/commit/37fd666a9a6788d5f0c59311499f29896b48bc82))
* improve console experience on mac ([15465bf](https://github.com/secondtruth/puter/commit/15465bfc5035a64762f7c86a3d38af8be6be5b59))
* incorrect error from suggested_apps ([b648817](https://github.com/secondtruth/puter/commit/b648817f2743c2b6214ebe4177d921c9b9027594))
* it was github actions the entire time ([602a198](https://github.com/secondtruth/puter/commit/602a19895c05b45a7d283470e7af3ae786be1bf2))
* Make polyfilled import.meta.filename getter a valid function ([85c6798](https://github.com/secondtruth/puter/commit/85c679844869b6b05fcbda231d8dc7026a66da97))
* make webpack output not look like errors ([ad3d318](https://github.com/secondtruth/puter/commit/ad3d318d07377c78c0429247225655e489b68be4))
* null email in request to /share ([bf63144](https://github.com/secondtruth/puter/commit/bf63144f7a79c48bd650ae851ddd0c8a10d748c3))
* oops ([a136ee5](https://github.com/secondtruth/puter/commit/a136ee5edd3149798a0d82f494f423f503b65f00))
* peers array assumption ([10cbf08](https://github.com/secondtruth/puter/commit/10cbf08233620440aa39f5302deaac4f59f02247))
* **phoenix:** Gracefully handle completing a non-existent path ([d76e713](https://github.com/secondtruth/puter/commit/d76e7130cba9f0ca05940abafe4fd1a41464aa83))
* property validation on some permission endpoints ([0855f2b](https://github.com/secondtruth/puter/commit/0855f2b36eca3bbdaa8429cbde3aa1242e8e96ee))
* read_only fields in ES ([e8f4c32](https://github.com/secondtruth/puter/commit/e8f4c328bff5c36b95fe460b80803e12e619f8ee))
* readdir on file ([a72ec97](https://github.com/secondtruth/puter/commit/a72ec9799ac3bd76ceafa22cce149e373a13f3b9))
* remove abnoxious debug file ([5c636d4](https://github.com/secondtruth/puter/commit/5c636d4fd25e14ba3813f7fca3b70ff7bd6860e7))
* remove flag that breaks puter-js webpack ([7aadae5](https://github.com/secondtruth/puter/commit/7aadae58ce1a51f925bf64c3d65ac1fa6971b164))
* remove last component when share URL is file ([1166e69](https://github.com/secondtruth/puter/commit/1166e69c76688d1811701c56cd4df9d38e286793))
* remove legacy permission check in stat ([f2c6e01](https://github.com/secondtruth/puter/commit/f2c6e01296e4214336e63bc2d69bcbf17f59890f))
* run mocha within packages in monorepo ([58c199c](https://github.com/secondtruth/puter/commit/58c199c15356ac087a04b16dd18e8fe0f1aea359))
* **security:** hoist acl check in ll_read ([6a2fbc1](https://github.com/secondtruth/puter/commit/6a2fbc1925952ecceed741afe138270d1eeda7b7))
* switch share notif username to sender ([cd65217](https://github.com/secondtruth/puter/commit/cd65217f5cda1c986ee231e2eeeef5abefa36ecb))
* syntax error and formatting issue ([3a09e84](https://github.com/secondtruth/puter/commit/3a09e84838fe8b74bd050641620eec87d9f59dfc))
* Throw an error when readdir is called on a non-directory ([46eb4ed](https://github.com/secondtruth/puter/commit/46eb4ed2b96c235e10e15645a30d2f192a1af0de))
* type error in puter-site ([d96f924](https://github.com/secondtruth/puter/commit/d96f924cad7a13ea6e9084bb0ebb79ecc5fcb8a3))
* ui color input attributes ([d9c4fbb](https://github.com/secondtruth/puter/commit/d9c4fbbd1dcce12ee05ee33652a5fa518196463d))
* update email share object ([9033f6f](https://github.com/secondtruth/puter/commit/9033f6f8c74ef8739294d640ac1c7eba95519bbd))
* update PD alert custom details ([2f16322](https://github.com/secondtruth/puter/commit/2f163221bdde09425cae11ef7f8e4eb0b10c7103))
* update test kernel ([55c609b](https://github.com/secondtruth/puter/commit/55c609b3fec4ef018febc6e88c44a6277960d728))
* validate size metadata ([2008db0](https://github.com/secondtruth/puter/commit/2008db08524259264a0c8186a34fc75d7a133f5f))
* well kinda (HOSTNAME in phoenix) ([7043b94](https://github.com/secondtruth/puter/commit/7043b9400c63842c4c54d82724167666708d3119))
